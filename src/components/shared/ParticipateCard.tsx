...
const ParticipateCard = ({label="Participate"}:{label?:string}) => {
  return (
    <section className="w-full border border-3 border-[#D9D9D9] rounded-2xl shadow-[0px 0px 5px 0px #00000040]">
      <img src={IMG.project} alt="" className="object-cover w-full h-[200px] rounded-t-xl" />
      <div className="text-center h-8 bg-normal-100 w-full text-white-100 py-1">
      ...
      <div className="p-6">
        ...
        <Text as="p" weight="extrabold text-[#696969]" className="mt-2">
          PolyLand Studios is a Web3 gaming studio focused on crafting innovativ...
        </Text>
